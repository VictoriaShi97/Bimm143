...
Here we focus on the Mexcian Ancestry in Los Angeles, California (MXL)
population
...
that tells us how good the sequence at a given postiion is (i.e. how
likley it is to be correct based on the instrument)
...
![](Clss13_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->
